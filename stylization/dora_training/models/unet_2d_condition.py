...
class UNet2DConditionModel(
    ...
    def forward(
        ...
        **kwargs,
        ...
        # print("kwargs keys in transformer.forward():", kwargs.keys())
        r"""
        ...
        for downsample_block in self.down_blocks:
            ...
            if hasattr(downsample_block, "has_cross_attention") and downsample_block.has_cross_attention:
                # print(downsample_block.__class__.__name__)  # CrossAttnDownBlock2D
                ...
                # print(downsample_block.__class__.__name__)  # DownBlock2D
        ...
        if self.mid_block is not None:
            if hasattr(self.mid_block, "has_cross_attention") and self.mid_block.has_cross_attention:
                # print(self.mid_block.__class__.__name__)  # UNetMidBlock2DCrossAttn
                ...
                # print(self.mid_block.__class__.__name__)
                sample = self.mid_block(sample, emb **kwargs)
        ...
        for i, upsample_block in enumerate(self.up_blocks):
            ...
            if hasattr(upsample_block, "has_cross_attention") and upsample_block.has_cross_attention:
                # print(upsample_block.__class__.__name__)
